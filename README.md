...
- [x] Stream support
- [x] GPT-4 support
  - If you have access to the GPT-4 or GPT-5 APIs, simply change the `OPENAI_MODEL` parameter to the preferred model identifier (e.g., `gpt-4`, `gpt-5`)
...
| `OPENAI_MODEL`                      | The OpenAI model to use for generating responses. You can find all available models [here](https://platform.openai.com/docs/models/)                                                                                                                                                    | `gpt-5`                           |
...
| `MAX_TOKENS`                        | Upper bound on how many tokens the ChatGPT API will return                                                                                                                                                                                                                              | `1200` for GPT-3, `2400` for GPT-4, `4096` for GPT-5 |
